...
public class UseCaseThreadPoolScheduler implements UseCaseScheduler {
    ...
    @Override
    public <V extends UseCase.ResponseValue> void onBusinessError(final String businessErrorMessage,final UseCase.UseCaseCallback<V> useCaseCallback) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                useCaseCallback.onBusinessError(businessErrorMessage);
            }
        });
    }
