...
public class OrderRecordWaitDistributeView extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private Button startDistrubiteBtn;

    private OrderRecordWaitDistributeView.CartListAdapter cartListAdapter;
    private OrderRecordWaitDistributeView.ItemClickListener mListener;
    ...
    public OrderRecordWaitDistributeView(ViewGroup parent, ItemClickListener listener) {
        super(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_order_waitdistribute, parent, false));
        ...
        printAgainBtn = (Button) itemView.findViewById(R.id.printAgainBtn);
        printAgainBtn.setOnClickListener(this);
        startDistrubiteBtn = (Button) itemView.findViewById(R.id.startDistrubiteBtn);
        startDistrubiteBtn.setOnClickListener(this);
    ...
    public void setData(Order item, int position) {
        ...
        foodTotalFree = foodTotalFree + item.getLunchPrice() + item.getSendPrice() - item.getDiscountPrice();
        ...
        foodDiscountFree = foodDiscountFree + foodDiscountFree;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.orderInfoIndicator:
                ...
                break;
            case R.id.printAgainBtn:
                mListener.printAgainClick(current_item);
                break;
            case R.id.startDistrubiteBtn:
                mListener.startDistributeClick(current_item);
                break;
        }
    }
