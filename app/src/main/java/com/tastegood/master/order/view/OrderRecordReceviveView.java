...
public class OrderRecordReceviveView extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    private TextView receviveTime;

    private CartListAdapter cartListAdapter;

    public OrderRecordReceviveView(ViewGroup parent) {
        super(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_order_recevive, parent, false));
        ...
        receviveTime = (TextView) itemView.findViewById(R.id.receviveTime);
    ...
    public void setData(Order item) {
        ...
        receviveTime.setText("送达时间：" + StringUtils.CoverLongTime2String(item.getSendoneTime()));
    }
